      ...
      <div class="container">
        ...
        <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
          <div class="mb-12 p-4 md:w-1/2">
            ...
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Landing Page Faldhi Ghifari</h3>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            ...
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">News Portal with Laravel</h3>
            <p class="text-base font-medium text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius, iusto! Aliquam, corporis.</p>
          </div>
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
            ...
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Cloning LG Mobile page</h3>
            <p class="text-base font-medium text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius, iusto! Aliquam, corporis.</p>
          </div>
        </div>
      </div>
