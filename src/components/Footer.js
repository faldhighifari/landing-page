      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            <h2 class="mb-5 text-4xl font-bold text-white">Fullstack Developer</h2>
            <h3 class="mb-2 text-2xl font-bold">Contact Me</h3>
            <p>faldhighifari248@gmail.com</p>
            <p>Jakarta</p>
          </div>
          <div class="mb-12 w-full px-4 md:w-1/3">
            <h3 class="mb-5 text-xl font-semibold text-white">My Blog</h3>
            <ul class="text-slate-300">
              <li>
                <a href="#" class="mb-3 inline-block text-base hover:text-primary">Lorem</a>
              </li>
              <li>
                <a href="#" class="mb-3 inline-block text-base hover:text-primary">Ipsum</a>
              </li>
              <li>
                <a href="#" class="mb-3 inline-block text-base hover:text-primary">Dolor</a>
              </li>
            </ul>
          </div>
          <div class="mb-12 w-full px-4 md:w-1/3">
            <h3 class="mb-5 text-xl font-semibold text-white">Links</h3>
            <ul class="text-slate-300">
              <li>
        ...
        <div class="w-full border-t border-slate-700 pt-10">
          ...
          <p class="text-center text-xs font-medium text-slate-500">
            Dibuat oleh <a href="https://instagram.com/sandhikagalih" target="_blank" class="font-bold text-primary">Faldhi Ghifari</a>, menggunakan
            <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500"> React & Tailwind CSS</a>.
          </p>
        </div>
      </div>
